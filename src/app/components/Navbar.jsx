    ...
    <div className=' w-full text-white bg-blue-400 py-3'>
        {
            !user ? (
                <div className='flex justify-around items-center'>
                    <p className=' text-3xl font-bold'> NewsMania </p>
                    <div> 
                        {
                            !auth ? 
                                <div>
                ...
                <div>
                    <div className='flex items-center justify-between sm:justify-around sm:px-0 px-5'>
                        <p className='cursor-pointer' onClick={()=>{Router.push("/")}}> <span className='text-xl'> { userData?.name?.split(" ")[0]}</span></p> 
                        <p className=' text-3xl font-bold hidden sm:flex'> NewsMania </p>
